...
def parse_arguments(argv):
    ...
    parser.add_argument('--logo', type=str, default=None, help='Path to the logo.')
...
"""
python face_preparation.py /data1/aliyun_code/facegen/images/base/xingchi/xingchi_mask2_aligned_600.png --mask --scale=0.45 --y=120 --ph=5
"""
